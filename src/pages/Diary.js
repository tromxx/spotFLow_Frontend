    ...
    return (
      <>
        <Container>
          ...
          <body>
          <DiaryDiv>
            {isSearch && <Slider setIsSearch={setIsSearch} isSearch={isSearch} email={user.email}
                                 names={`${search.length} 개의 검색결과`} setName={setName} setIsType={() => setIsType(true)}
                                 setIsAll={setIsAll} data={search}/>}
        ...
        <>
          {isType ?
            <DiaryCategory isType={isType} fetchData={fetchHotData} name={"Popular"} setIsAll={setIsAll}
                           data={hotData}/> :
            <DiaryCategory isType={isType} fetchData={fetchFriendData} name={"Friend"} setIsAll={setIsAll}
                           data={friendData}/>
          }
        </>
      </>
