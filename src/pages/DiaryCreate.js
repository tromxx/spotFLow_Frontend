    ...
    <Container>
        <TopMenu>
            <div className='menu'>
                ...
                <div className='right'><CreateBtn onClick={()=> handlePost(title,text)}><MdPostAdd/></CreateBtn> </div>
            </div>
        </TopMenu>
        <Main>
            <div className='Container'>
                <div className='user'>
                        ...
                        <div className='user-info'>
                            <div style={{width:"90%",backgroundColor:"#F9F9F9"}}>닉네임</div>
                            <div style={{width:"90%",backgroundColor:"#F9F9F9"}}>{`${year}년 ${month}월 ${date}일 ${hours}시 ${minutes}분`}</div>
                        </div>
                </div>

               <div className='title'>
                    <input ref={title} className='' type="text" style={{padding: "10px 20px", outline: "none",margin: "5px 0", boxSizing: "border-box",border: "none",width:"100%",height:"99%"}}/>
                </div>
                ...
                <div className='add-list'>
                    <div className='list-box'>
                        ...
                        <div className='item' key={e.id}>
                            <MdCancel onClick={()=> {handleDelete(e)}} className='button'/>
                            {e.title}    
                        </div>)}
                    </div>
                    <CreateBtn className='btnplus' onClick={()=>{setIsCreate(!isCreate)}} style={{width: "16%",height: "80%",marginRight:"0px",marginLeft:"5px",backgroundColor:"#A1EAFB"}}> <AiOutlinePlus/></CreateBtn>
                </div>
